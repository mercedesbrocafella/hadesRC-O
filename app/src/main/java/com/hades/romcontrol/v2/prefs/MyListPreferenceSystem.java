...
public class MyListPreferenceSystem extends ListPreference implements Preference.OnPreferenceChangeListener {
    ...
    public MyListPreferenceSystem(Context context, AttributeSet attrs) {
        super(context, attrs);
