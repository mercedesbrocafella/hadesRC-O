package com.hades.romcontrol.v2.prefs;
...
import com.hades.romcontrol.v2.utils.AppInfo;
import com.hades.romcontrol.v2.utils.AppListTask;
import com.hades.romcontrol.v2.utils.Utils;
...
public class IntentDialogPreference extends DialogPreference implements AdapterView.OnItemClickListener, AppListTask.OnListCreatedListener {
    ...
    @Override
    public void onListCreated(List<com.hades.romcontrol.v2.utils.AppInfo> appInfoList) {
