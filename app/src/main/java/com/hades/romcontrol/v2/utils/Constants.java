...
public class Constants {
    ...
    public static final String SERVICE_INTENT_ACTION_BACKUP = "com.hades.action.BACKUP";
    public static final String SERVICE_INTENT_ACTION_RESTORE = "com.hades.action.RESTORE";
