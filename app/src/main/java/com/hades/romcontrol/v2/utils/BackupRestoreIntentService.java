...
import com.hades.romcontrol.v2.MainActivity;
...
public class BackupRestoreIntentService extends IntentService {
    ...
    private class LocalReceiver extends BroadcastReceiver {
        static final String BACKUP_COMPLETE_ACTION = "com.hades.action.BACKUP_COMPLETE";
        static final String RESTORE_COMPLETE_ACTION = "com.hades.action.RESTORE_COMPLETE";
